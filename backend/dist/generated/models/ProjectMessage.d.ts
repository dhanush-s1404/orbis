...
export type GetProjectMessageAggregateType<T extends ProjectMessageAggregateArgs> = {
    [P in keyof T & keyof AggregateProjectMessage]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateProjectMessage[P]> : Prisma.GetScalarType<T[P], AggregateProjectMessage[P]>;
};
...
export type GetProjectMessageGroupByPayload<T extends ProjectMessageGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<ProjectMessageGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof ProjectMessageGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], ProjectMessageGroupByOutputType[P]> : Prisma.GetScalarType<T[P], ProjectMessageGroupByOutputType[P]>;
}>>;
...
export type ProjectMessageScalarWhereWithAggregatesInput = {
    ...
    message?: Prisma.StringWithAggregatesFilter<"ProjectMessage"> | string;
...
export type ProjectMessageCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<ProjectMessageFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface ProjectMessageDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * })
    **/
    count<T extends ProjectMessageCountArgs>(args?: Prisma.Subset<T, ProjectMessageCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], ProjectMessageCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends ProjectMessageGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, ProjectMessageGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetProjectMessageGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export interface ProjectMessageFieldRefs {
    ...
    readonly message: Prisma.FieldRef<"ProjectMessage", 'String'>;
