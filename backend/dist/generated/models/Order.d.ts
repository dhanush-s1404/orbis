...
export type OrderOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "userId" | "total" | "currency" | "paymentStatus" | "orderStatus" | "paymentId" | "sessionId" | "createdAt" | "updatedAt", ExtArgs["result"]["order"]>;
